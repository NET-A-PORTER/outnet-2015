...
```html
<link rel="stylesheet" href="//cache.theoutnet.com/preston-assets/2.4.15/css/outnet-2015.css">
```
...
```bash
bower install --save outnet-2015#v2.4.15
```

```
npm install --save outnet-2015#v2.4.15
```

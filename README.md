...
```html
<link rel="stylesheet" href="//cache.theoutnet.com/preston-assets/v2.4.5/css/outnet-2015.css">
```
...
```bash
bower install --save outnet-2015#v2.4.5
```

```
npm install --save outnet-2015#v2.4.5
```
